...
class camera(pygame.sprite.Group):
    ...
    def c_draw(self,player,moves,tiles,mx,my,enemy_group,spawner_group,collectable_group,bullet_group,footprint_group):
        ...
        for sprite in sorted(self.sprites(),key = lambda sprite: sprite.z):
            ...
            if sprite.type == "tile":
                ...
                if sprite.update(moves,tiles,mx,my,bullet_group,footprint_group,enemy_group,spawner_group):
                    return True
            #tile,portal,player should always be rendered and updating
                ...
                if dist <= self.render_dist:
                    ...
                    if sprite.type == "particle":
                        ...
                        if dist <= self.sim_dist:
                            sprite.update(tiles,mx,my,player,enemy_group,spawner_group)
                        ...
                        self.display_surface.blit(sprite.rot_image,img_offset_pos)
                        if dist <= self.sim_dist:
                            sprite.update(player,tiles,dist,collectable_group,spawner_group,bullet_group,enemy_group,img_offset_pos)
